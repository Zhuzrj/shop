...
<%@page import="com.oracle.shop.model.javabean.Shopcar"%>
	...
	<header>
		<div class="head w1190">
			<div class="headLeft">
				<div class="loginuser">
					<a href="#">
						<span>您好，1286982164@qq.com </span>
						<span>|</span>
					</a>
				</div>
				<div class="loginout">
...
<!-- 						</a> -->
					...
					<ul class="IAul">
						...
						<li class="price">
							<strong>¥ <u><%=c.getPrice() %></u></strong><br>
							<s><%=c.getPrice()+50 %>元</s>
						</li>
						<li class="num">
			...
			<div class="account">
				<ul>
					<li>收货人:<input type="text" name="username" style="height: 25px;font-size: 14px;box-shadow:0px 0px 3px orange"/></li>
